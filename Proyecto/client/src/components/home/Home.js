...
const Home = () => {
  ...
  React.useEffect(() => {
    let cookies = getCookie("cookieConsent");
    if (cookies == null) {
      setOpen(true);
    } else {
      setOpen(false);
  ...
  const handleClose = (event, reason) => {
    ...
    if (cookies == null) {
      ...
      document.cookie =
        "cookieConsent=true; expires=" + CookieDate.toGMTString() + ";";
    }
  };
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6} lg={4}>
                <div className="grid-compo">
                  ...
                  <br />
                  <Typography variant="body1">
                    Video classes of the highest quality and realism and with
                    the best music
                  </Typography>
                </div>
              </Grid>
